...
/********************************************************************************
 * Description      : afficher le contenu du bouton appui�
 * Param�tres       : Aucun
 * Type de retour   : void
 *******************************************************************************/
void Calculatrice::digitClicked()
{
    ...
    if(display->text() =="0" && digitValue == 0.0) /* si le contenu du bouton appui� est 0 , et le text
                                                   d�j� affich� est 0 , on fait rien */
        return;
    ...
    display->setText(display->text() + QString::number(digitValue)); /* on affiche le text qui �tait avant avec le
                                                                     contenu du bouton appui� */

}

/********************************************************************************
 * Description      : calcule et affiche le resultat de l'operation choisie entre
 1/x , racine(x)et carr�(x)
 * Param�tres       : Aucun
 * Type de retour   : void
 *******************************************************************************/
void Calculatrice::unaryOperatorClicked()
{
    ...
    if(clickedOperator == tr("Sqrt")) // si le bouton cliqu� est 'sqrt'
    {
        try
        {
            if(operand < 0.0)
    ...
    display->setText(QString::number(result));     // on affiche le r�sultat
    waitingForOperand = true;                       // on se met en atente pour nouvelle entr�e d'op�rande
}

/**********************************************************************************************
 * Description      : reconnait l'op�rateur '+' et "-"
 * Param�tres       : Aucun
 * Type de retour   : void
 **********************************************************************************************/
...
/********************************************************************************
 * Description      : R�initialise toutes les valeurs et toutes les op�rations
 * Param�tres       : Aucun
 * Type de retour   : void
 *******************************************************************************/
