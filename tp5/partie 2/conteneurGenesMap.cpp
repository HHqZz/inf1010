 ...
 * Param�tres       : int , string, string, string, string
 * Type de retour   : void
 ****************************************************************************************************/
 ...
 * Param�tres       : int
 * Type de retour   : Renvoie True si le gene dont l'id a �t� donn� en parametre est retir�
 ****************************************************************************************************/
 ...
 * Param�tres       : string espece
 * Type de retour   : Renvoie un int contenant le nombre genes supprim�s
 ******************************************************************************************************************************/
unsigned int ConteneurGenesMap::retirerEspece(const string &espece) {
	...
	if (!map_.empty())												//on verifie si la map est vide ou non
	{
		...
		{
			if (it->second->getEspece() == espece)				//if trouv�, on le supprime
			{
				delete(it->second);
 ...
 * Param�tres       : string espece , Ostream out
 * Type de retour   : Void
 *************************************************************************************************************************/
 ...
 * Param�tres       : string , map<string, string>
 * Type de retour   : int
 *************************************************************************************************************************/
